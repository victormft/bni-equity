...
namespace Equity\Controller {
	...
	class Admin extends \Equity\Core\Controller {
            ...
            switch ($action) {
                ...
                case 'send':
                    ...
                    if ($action == 'send') {
                        ...
                        // blind copy a EQUITY desactivado durante las verificaciones
            //              $mailHandler->bcc = 'comunicaciones@EQUITY.org';
 ...
 */
    ...
    //                Model\License::delete($id);
        ...
        public function tags($action = 'list', $id = null) {
            ...
            $model = 'Equity\Model\Blog\Post\Tag';
            $url = '/admin/tags';
                ...
                case 'manage':
                    ...
                    if (!empty($sql)) {
                        ...
                        if (Model\User::query($sql, array(':user'=>$id))) {
                            ...
                            $msgi = ("Ha <strong>%s</strong> al usuario <strong>%s</strong> CORRECTAMENTE");
                            ...
                            $msgi = ("Ha FALLADO cuando ha <strong>%s</strong> al usuario <strong>%s</strong>");
...
*/
        ...
        public function blog ($action = 'list', $id = null) {
            ...
            if (!$blog instanceof \Equity\Model\Blog) {
			...
			if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    ...
                    if ($post->save($errors)) {
                        ...
                        if ((bool) $post->publish) {
                            ...
                            //sino lo quitamos
                            \Equity\Core\Model::query("DELETE FROM feed WHERE url = '/blog/{$post->id}' AND scope = 'public' AND type = 'equity'");
                        }
...
//                                'projects'  => $projects,
                    ...
                    case 'send':
                        ...
                        foreach ($_POST as $key=>$value) {
                            $matches = array();
                            \preg_match('#receiver(\w+)#', $key, $matches);
//                            echo \trace($matches);
