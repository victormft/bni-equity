...
//                            $log_action = 'Modificado su información de perfil'; //feed admin
                    ...
                    case 'access':
                        ...
                        if(!empty($_POST['user_nemail']) || !empty($_POST['user_remail'])) {
                            ...
                            elseif(!\Equity\Library\Check::mail($_POST['user_nemail'])) {
                    ...
                    // porque los usuarios que acceden mediante servicio no tienen contraseña
                            ...
                            */
                            ...
                            elseif(!\Equity\Library\Check::password($_POST['user_npassword'])) {
         ...
         *      'licencia' el acuerdo entre Equity y el usuario, licencia cc-by-nc-nd, enlace al pdf
...
//                                    $mailHandler->bcc = 'comunicaciones@Equity.org';
        ...
        public function translates ($option = 'overview', $action = 'list', $id = null) {
            ...
            $langs = \Equity\Library\Lang::getAll();
