...
<div class="widget board">
    <form method="post" action="<?php echo SITE_URL ?>/admin/footer">
        ...
        <p>Solo se está asignando al footer una entrada ya publicada. Para gestionar las entradas ir a la <a href="<?php echo SITE_URL ?>/admin/blog" target="_blank">gestión de blog</a></p>
