    ...
    <?php foreach ($this['projects'] as $project) : ?>
        <div class="widget board">
            <table>
                ...
                <tbody>
                    <tr>
                        <td><a href="<?php echo SITE_URL ?>/project/<?php echo $project->project; ?>" target="_blank" title="Preview"><?php echo $project->name; ?></a></td>
                        ...
                        <td><a href="<?php echo SITE_URL ?>/admin/reviews/edit/<?php echo $project->project; ?>/<?php echo $filter; ?>">[Editar]</a></td>
                        <td><a href="<?php echo SITE_URL ?>/admin/reviews/report/<?php echo $project->project; ?>" target="_blank">[Ver informe]</a></td>
                            <?php if ( $project->status > 0 ) : ?>
                        <td><a href="<?php echo SITE_URL ?>/admin/reviews/close/<?php echo $project->review; ?>/<?php echo $filter; ?>">[Cerrar]</a></td>
                            <?php else : ?>
                        <td>Revisión cerrada</td>
                            <?php endif; ?>
                        <?php else : ?>
                        <td><a href="<?php echo SITE_URL ?>/admin/reviews/add/<?php echo $project->project; ?>/<?php echo $filter; ?>">[Iniciar revision]</a></td>
                        <td></td>
                        <?php endif; ?>
                        <td><?php if ($project->translate) : ?><a href="<?php echo SITE_URL ?><?php echo "/admin/translates/edit/{$project->project}"; ?>">[Ir a traducción]</a>
                        <?php else : ?><a href="<?php echo SITE_URL ?><?php echo "/admin/translates/add/?project={$project->project}"; ?>">[Habilitar traducción]</a><?php endif; ?></td>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><?php if ($checker->ready) : ?>Listo <a href="<?php echo SITE_URL ?>/admin/reviews/unready/<?php echo $project->review; ?>/<?php echo $filter; ?>&user=<?php echo $user; ?>">[Reabrir]</a><?php endif ?></td>
                    <td><a href="<?php echo SITE_URL ?>/admin/reviews/unassign/<?php echo $project->review; ?>/<?php echo $filter; ?>&user=<?php echo $user; ?>">[Desasignar]</a></td>
                </tr>
                <?php endforeach; ?>
                <?php if ($project->status > 0) : ?>
                <tr>
