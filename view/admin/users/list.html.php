...
<div class="widget board">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td><a href="<?php echo SITE_URL ?>/admin/users/manage/<?php echo $user->id; ?>">[Gestionar]</a></td>
                <td><a href="<?php echo SITE_URL ?>/user/<?php echo $user->id; ?>" target="_blank" title="Preview"><?php echo $user->name; ?></a></td>
                ...
                <td><a href="<?php echo SITE_URL ?>/admin/users/edit/<?php echo $user->id; ?>">[Editar]</a></td>
                <td><a href="<?php echo SITE_URL ?>/admin/users/impersonate/<?php echo $user->id; ?>">[Suplantar]</a></td>
            </tr>
            <?php endforeach; ?>
        </tbody>
