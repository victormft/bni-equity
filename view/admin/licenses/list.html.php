...
<!--                                <td> Remove </td> -->
        ...
        <tbody>
            ...
            <tr>
                <td><a href="<?php echo SITE_URL ?>/admin/licenses/edit/<?php echo $license->id; ?>/?filter=<?php echo $filters['group']; ?>">[Editar]</a></td>
                <td><?php echo $license->name; ?></td>
                <td><img src="<?php echo SITE_URL ?>/view/css/license/<?php echo $license->id; ?>.png" alt="<?php echo $license->id; ?>" title="<?php echo $license->name; ?>" /></td>
                ...
                <td><a href="<?php echo SITE_URL ?>/admin/licenses/up/<?php echo $license->id; ?>/?filter=<?php echo $filters['group']; ?>">[&uarr;]</a></td>
                <td><a href="<?php echo SITE_URL ?>/admin/licenses/down/<?php echo $license->id; ?>/?filter=<?php echo $filters['group']; ?>">[&darr;]</a></td>
                <?php if ($translator) : ?>
                <td><a href="<?php echo SITE_URL ?>/translate/license/edit/<?php echo $license->id; ?>" >[Traducir]</a></td>
                <?php endif; ?>
<!--                                <td><a href="<?php echo SITE_URL ?>/admin/licenses/remove=<?php echo $license->id; ?>/?filter=<?php echo $filters['group']; ?>" onclick="return confirm('Seguro que deseas eliminar este registro?');">[Quitar]</a></td>  -->
            </tr>
            <?php endforeach; ?>
        </tbody>
