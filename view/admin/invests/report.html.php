...
// para cada metodo acumulamos desglose, comision * 0.08, pago * 0.092
    ...
    $equity[$invest->method] += ($invest->amount * 0.08);
...
<div class="widget report">
    ...
    <table>
        ...
        <tr>
            ...
            <td style="text-align:right;"><?php echo \amount_format($equity['paypal'], 2) ?></td>
        ...
        <tr>
            ...
            <td style="text-align:right;"><?php echo \amount_format($equity['tpv'], 2) ?></td>
        ...
        <tr>
            ...
            <td style="text-align:right;"><?php echo \amount_format($equity['cash'], 2) ?></td>
        ...
        <tr>
            ...
            <td style="text-align:right;"><?php echo \amount_format(($equity['paypal'] + $equity['tpv'] + $equity['cash']), 2) ?></td>
...
<?php if (!empty($Data['tpv'])) : ?>
    ...
    <table>
        ...
        <tr>
            <?php
            $Data['tpv']['first']['equity']  = $Data['tpv']['first']['net']  * 0.08;
            $Data['tpv']['second']['equity'] = $Data['tpv']['second']['net'] * 0.08;
            $Data['tpv']['total']['equity']  = $Data['tpv']['total']['net']  * 0.08;
            ?>
            <th>Equity</th>
            <td style="text-align:right;"><?php echo \amount_format($Data['tpv']['first']['equity'], 2) ?></td>
            <td style="text-align:right;"><?php echo \amount_format($Data['tpv']['second']['equity'], 2) ?></td>
            <td style="text-align:right;"><?php echo \amount_format($Data['tpv']['total']['equity'], 2) ?></td>
            <td>8&#37; del neto</td>
        </tr>
        <tr>
            <?php
            $Data['tpv']['first']['project']  = $Data['tpv']['first']['net']  - $Data['tpv']['first']['equity'];
            $Data['tpv']['second']['project'] = $Data['tpv']['second']['net'] - $Data['tpv']['second']['equity'];
            $Data['tpv']['total']['project']  = $Data['tpv']['total']['net']  - $Data['tpv']['total']['equity'];
            ?>
            <th>Proyecto</th>
...
<?php if (!empty($Data['paypal'])) : ?>
    ...
    <table>
        ...
        <tr>
            <?php
            $Data['paypal']['first']['equity']  = $Data['paypal']['first']['ok'] * 0.08;
            $Data['paypal']['second']['equity'] = $Data['paypal']['second']['ok'] * 0.08;
            $Data['paypal']['total']['equity']  = $Data['paypal']['total']['ok'] * 0.08;
            ?>
            <th>Equity</th>
            <td style="text-align:right;"><?php echo \amount_format($Data['paypal']['first']['equity'], 2) ?></td>
            <td style="text-align:right;"><?php echo \amount_format($Data['paypal']['second']['equity'], 2) ?></td>
            <td style="text-align:right;"><?php echo \amount_format($Data['paypal']['total']['equity'], 2) ?></td>
            <td>8&#37; de las operaciones correctas</td>
        </tr>
        <tr>
            <?php
            $Data['paypal']['first']['project']  = $Data['paypal']['first']['ok']  - $Data['paypal']['first']['equity'];
            $Data['paypal']['second']['project'] = $Data['paypal']['second']['ok'] - $Data['paypal']['second']['equity'];
            $Data['paypal']['total']['project']  = $Data['paypal']['total']['ok']  - $Data['paypal']['total']['equity'];
            ?>
            <th>Proyecto</th>
        ...
        <tr>
            <?php
            $Data['paypal']['first']['fee_equity']  = ($Data['paypal']['first']['invests'] * 0.35) + ($Data['paypal']['first']['equity'] * 0.034);
            $Data['paypal']['second']['fee_equity'] = ($Data['paypal']['second']['invests'] * 0.35) + ($Data['paypal']['second']['equity'] * 0.034);
            $Data['paypal']['total']['fee_equity']  = ($Data['paypal']['total']['invests'] * 0.35) + ($Data['paypal']['total']['equity'] * 0.034);
            ?>
            <th>Fee a Equity</th>
            <td style="text-align:right;"><?php echo \amount_format($Data['paypal']['first']['fee_equity'], 2) ?></td>
            <td style="text-align:right;"><?php echo \amount_format($Data['paypal']['second']['fee_equity'], 2) ?></td>
            <td style="text-align:right;"><?php echo \amount_format($Data['paypal']['total']['fee_equity'], 2) ?></td>
            <td>0,35 por operacion + 3,4&#37; del importe de equity (8&#37; del correcto)</td>
        </tr>
        <tr>
            <?php
        ...
        <tr>
            <?php
            $Data['paypal']['first']['net_equity']  = $Data['paypal']['first']['equity']  - $Data['paypal']['first']['fee_equity'];
            $Data['paypal']['second']['net_equity'] = $Data['paypal']['second']['equity'] - $Data['paypal']['second']['fee_equity'];
            $Data['paypal']['total']['net_equity']  = $Data['paypal']['total']['equity']  - $Data['paypal']['total']['fee_equity'];
            ?>
            <th>Neto Equity</th>
            <td style="text-align:right;"><?php echo \amount_format($Data['paypal']['first']['net_equity'], 2) ?></td>
            <td style="text-align:right;"><?php echo \amount_format($Data['paypal']['second']['net_equity'], 2) ?></td>
            <td style="text-align:right;"><?php echo \amount_format($Data['paypal']['total']['net_equity'], 2) ?></td>
            <td></td>
        </tr>
        <tr>
            <?php
