...
<div class="widget">
    ...
    <p>
        ...
        <a href="<?php echo SITE_URL ?>/admin/invests/cancel/<?php echo $invest->id ?>"
        ...
        <a href="<?php echo SITE_URL ?>/admin/invests/execute/<?php echo $invest->id ?>"
        ...
        <a href="<?php echo SITE_URL ?>/admin/invests/move/<?php echo $invest->id ?>" class="button weak">Reubicar este aporte</a>
        <?php endif; ?>
    </p>
    ...
    <dl>
        <dt>Códigos de seguimiento: <a href="<?php echo SITE_URL ?>/admin/accounts/details/<?php echo $invest->id ?>">Ir a la transacción</a></dt>
        <dd><?php
