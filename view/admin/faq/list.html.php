...
<div class="widget board">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td><a href="<?php echo SITE_URL ?>/admin/faq/edit/<?php echo $faq->id; ?>/?filter=<?php echo $this['filter']; ?>">[Editar]</a></td>
                <td><?php echo $faq->title; ?></td>
                <td><?php echo $faq->order; ?></td>
                <td><a href="<?php echo SITE_URL ?>/admin/faq/up/<?php echo $faq->id; ?>/?filter=<?php echo $this['filter']; ?>">[&uarr;]</a></td>
                <td><a href="<?php echo SITE_URL ?>/admin/faq/down/<?php echo $faq->id; ?>/?filter=<?php echo $this['filter']; ?>">[&darr;]</a></td>
                <?php if ($translator) : ?>
                <td><a href="<?php echo SITE_URL ?>/translate/faq/edit/<?php echo $faq->id; ?>" >[Traducir]</a></td>
                <?php endif; ?>
                <td><a href="<?php echo SITE_URL ?>/admin/faq/remove/<?php echo $faq->id; ?>/?filter=<?php echo $this['filter']; ?>" onclick="return confirm('Seguro que deseas eliminar este registro?');">[Quitar]</a></td>
            </tr>
            <?php endforeach; ?>
        </tbody>
