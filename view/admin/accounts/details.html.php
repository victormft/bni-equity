...
<div class="widget">
    ...
    <h3>Operaciones</h3>
    <p>
            <a href="<?php echo SITE_URL ?>/admin/invests/return/<?php echo $invest->id ?>"
    ...
    <dl>
        <dt>Códigos de seguimiento: <a href="<?php echo SITE_URL ?>/admin/invests/details/<?php echo $invest->id ?>">Ir al aporte</a></dt>
        <dd><?php
