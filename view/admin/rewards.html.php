...
$status = Equity\Model\Project::status();
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="<?php echo SITE_URL ?><?php echo "/admin/rewards/fulfill/{$reward->id}{$filter}"; ?>">[Dar por cumplido]</a></td>
                    <?php else : ?>
                    <td><a href="<?php echo SITE_URL ?><?php echo "/admin/rewards/unfill/{$reward->id}{$filter}"; ?>">[Dar por pendiente]</a></td>
                    <?php endif; ?>
                </tr>
                <?php endforeach; ?>
            </tbody>
