...
<div class="widget project-support collapsable" id="project-support">
    ...
    <div class="buttons">
        ...
        <a class="button violet supportit" href="<?php echo SITE_URL ?>/project/<?php echo $project->id; ?>/invest"><?php echo Text::get('regular-invest_it'); ?></a>
        <?php else : ?>
        <a class="button view" href="<?php echo SITE_URL ?>/project/<?php echo $project->id ?>/updates"><?php echo Text::get('regular-see_blog'); ?></a>
        <?php endif; ?>
        <a class="more" href="<?php echo SITE_URL ?>/project/<?php echo $project->id; ?>/needs"><?php echo Text::get('regular-see_more'); ?></a>
    </div>
