    ...
    <div id="main">
        <div class="login">
            <div>
                ...
                <a href="<?php echo SITE_URL ?>/user/recover"><?php echo Text::get('login-recover-link'); ?></a>
        ...
        <div class="external-login">
            <div>
				...
				$openid = $_COOKIE['equity_oauth_provider'];

				//l'ordre que es vulgui...
                $logins = array(
					'facebook' => '<a href="<?php echo SITE_URL ?>/user/oauth?provider=facebook">' . Text::get('login-signin-facebook') . '</a>',
					'twitter' => '<a href="<?php echo SITE_URL ?>/user/oauth?provider=twitter">' . Text::get('login-signin-twitter') . '</a>',
					'Google' => '<a href="<?php echo SITE_URL ?>/user/oauth?provider=Google">' . Text::get('login-signin-google') . '</a>',
					'Yahoo' => '<a href="<?php echo SITE_URL ?>/user/oauth?provider=Yahoo">' . Text::get('login-signin-yahoo') . '</a>',
					'myOpenid' => '<a href="<?php echo SITE_URL ?>/user/oauth?provider=myOpenid">' . Text::get('login-signin-myopenid') . '</a>',
					'linkedin' => '<a href="<?php echo SITE_URL ?>/user/oauth?provider=linkedin">' . Text::get('login-signin-linkedin') . '</a>',
					'openid' => ''
                );
                $is_openid = !array_key_exists($openid,$logins);
                $logins['openid'] = '<form><input type="text"'.($is_openid ? ' class="used"' : '').' name="openid" value="' . htmlspecialchars( $is_openid ? $openid : Text::get('login-signin-openid')) . '" /><a href="<?php echo SITE_URL ?>/user/oauth" class="button">' . Text::get('login-signin-openid-go') . '&rarr;</a></form>';
